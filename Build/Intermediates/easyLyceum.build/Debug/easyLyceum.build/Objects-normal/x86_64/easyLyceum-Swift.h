...
SWIFT_CLASS("_TtC10easyLyceum11AppDelegate")
...
SWIFT_CLASS("_TtC10easyLyceum7Console")
@interface Console : NSTextView
@property (nonatomic, strong) ViewController * _Nullable parent;
...
SWIFT_CLASS("_TtC10easyLyceum14ViewController")
@interface ViewController : NSViewController
@property (nonatomic, strong) IBOutlet Console * _Null_unspecified console;
...
- (NSString * _Nonnull)openFileDialog:(NSString * _Nonnull)windowTitle message:(NSString * _Nonnull)message filetypelist:(NSString * _Nonnull)filetypelist;
